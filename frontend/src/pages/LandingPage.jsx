                ...
                <div className="w-full px-4 sm:px-6 lg:px-8">
                    <div className="flex justify-between items-center h-20">
                        <a href="#home" className="flex items-center gap-2 cursor-pointer transition-opacity hover:opacity-90">
                            ...
                            <div>
                                <span className="text-xl font-bold text-gray-900 dark:text-white leading-none block">
            ...
            <main>
                ...
                <section id="home" className="relative min-h-screen pt-32 pb-20 lg:pt-48 lg:pb-32 overflow-hidden">
                    <div className="absolute inset-0 z-0">
                        <div className="absolute inset-0 bg-[url('/hero_image.jpeg')] bg-cover bg-fixed bg-center" />
                        ...
                        <div className="grid md:grid-cols-2 gap-12 mb-20">
                            ...
                            >
                                ...
                                <div className="relative bg-white dark:bg-gray-800 p-10 rounded-3xl border border-gray-100 dark:border-gray-700 shadow-xl shadow-blue-900/5 dark:shadow-none h-full flex flex-col items-center text-center transition-colors">
                                    ...
                                    <h4 className="text-2xl font-bold text-gray-900 dark:text-white mb-6 font-serif tracking-wide">{lang === 'am' ? 'ራዕይ' : 'Vision'}</h4>
                            ...
                            >
                                ...
                                <div className="relative bg-white dark:bg-gray-800 p-10 rounded-3xl border border-gray-100 dark:border-gray-700 shadow-xl shadow-blue-900/5 dark:shadow-none h-full flex flex-col items-center text-center transition-colors">
                                    ...
                                    <h4 className="text-2xl font-bold text-gray-900 dark:text-white mb-6 font-serif tracking-wide">{lang === 'am' ? 'ተልዕኮ' : 'Mission'}</h4>
                                    <p className="text-gray-600 dark:text-gray-300 text-xl leading-relaxed italic font-serif">
                                        {lang === 'am'
                        ...
                        <div className="grid md:grid-cols-2 gap-12">
                            ...
                            >
                                <div className="flex items-center gap-4 mb-8">
                                    ...
                                    <h4 className="text-2xl font-bold text-gray-900 dark:text-white font-serif">{lang === 'am' ? 'ግቦች' : 'Strategic Goals'}</h4>
                                </div>
                            ...
                            >
                                ...
                                <div className="relative z-10">
                                    <div className="flex items-center gap-4 mb-10">
                                        ...
                                        <h4 className="text-2xl font-bold font-serif">{lang === 'am' ? 'ተቋማዊ እሴቶች' : 'Core Values'}</h4>
                                    </div>
