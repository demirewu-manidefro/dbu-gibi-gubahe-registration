...
const initDb = async () => {
    try {
        ...
        await query(`
            ...
            ALTER TABLE students ADD COLUMN IF NOT EXISTS trainee_type VARCHAR(50);
            ALTER TABLE students ADD COLUMN IF NOT EXISTS teacher_training JSONB;
            ALTER TABLE students ADD COLUMN IF NOT EXISTS leadership_training JSONB;
            ALTER TABLE students ADD COLUMN IF NOT EXISTS other_trainings TEXT;
            ALTER TABLE students ADD COLUMN IF NOT EXISTS additional_info TEXT;
            ALTER TABLE students ADD COLUMN IF NOT EXISTS filled_by VARCHAR(100);
            ALTER TABLE students ADD COLUMN IF NOT EXISTS photo_url TEXT;
            ALTER TABLE students ADD COLUMN IF NOT EXISTS baptismal_name VARCHAR(100);
            ALTER TABLE students ADD COLUMN IF NOT EXISTS priesthood_rank VARCHAR(50);
            ALTER TABLE students ADD COLUMN IF NOT EXISTS mother_tongue VARCHAR(50);
            ALTER TABLE students ADD COLUMN IF NOT EXISTS other_languages TEXT;
            ALTER TABLE students ADD COLUMN IF NOT EXISTS region VARCHAR(50);
            ALTER TABLE students ADD COLUMN IF NOT EXISTS zone VARCHAR(50);
            ALTER TABLE students ADD COLUMN IF NOT EXISTS woreda VARCHAR(50);
            ALTER TABLE students ADD COLUMN IF NOT EXISTS kebele VARCHAR(50);
            ALTER TABLE students ADD COLUMN IF NOT EXISTS phone VARCHAR(20);
            ALTER TABLE students ADD COLUMN IF NOT EXISTS gibi_name VARCHAR(100);
            ALTER TABLE students ADD COLUMN IF NOT EXISTS center_and_woreda VARCHAR(100);
            ALTER TABLE students ADD COLUMN IF NOT EXISTS parish_church VARCHAR(100);
            ALTER TABLE students ADD COLUMN IF NOT EXISTS emergency_name VARCHAR(100);
            ...
            ALTER TABLE students ADD COLUMN IF NOT EXISTS service_section VARCHAR(50);
